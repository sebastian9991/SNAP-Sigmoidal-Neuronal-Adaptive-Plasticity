...
from utils.experiment_utils.experiment_constants import DataSets, LayerNames
...
class InputLayer(NetworkLayer, ABC):
    ...
    @staticmethod
    def convert(
        img_file: str, label_file: str, out_file: str, data_size: int, img_size: int
    ) -> None:
        raise NotImplementedError("This method has yet to be implemented.")
    ...
    def update_bias(self, output: torch.Tensor):
        pass
    ...
    def _eval_forward(self, input: torch.Tensor):
        pass

    def visualize_weights(self, result_path: str, num: int, use: str, fname: str):
        pass

    def active_weights(self, beta: float):
        pass
